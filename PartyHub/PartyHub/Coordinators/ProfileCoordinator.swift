...
/// Координатор ProfileCoordinator'a
final class ProfileCoordinator: PresentableProtocol {
    ...
    public func start(_ viewController: UIViewController) -> UINavigationController {
        ...
        navigationVC.tabBarItem = UITabBarItem(title: model.title, image: model.image, tag: 2)
        return navigationVC
    }
}
